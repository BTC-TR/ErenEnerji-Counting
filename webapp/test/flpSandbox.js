		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Counting App",
									"targetURL": "#comerencounting-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comerencounting-display": {
								"semanticObject": "comerencounting",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.eren.counting",
									"url": sap.ui.require.toUrl("com/eren/counting")
								}
							}
						}
					}
